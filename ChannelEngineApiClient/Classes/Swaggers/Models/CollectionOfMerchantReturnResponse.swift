...
open class CollectionOfMerchantReturnResponse: Codable {
    ...
    public init(content: [MerchantReturnResponse]?, count: Int?, totalCount: Int?, itemsPerPage: Int?, statusCode: Int?, success: Bool?, message: String?, validationErrors: [String:[String]]?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        content = try container.decodeIfPresent([MerchantReturnResponse].self, forKey: "Content")
