...
open class CollectionOfMerchantOrderResponse: Codable {
    ...
    public init(content: [MerchantOrderResponse]?, count: Int?, totalCount: Int?, itemsPerPage: Int?, statusCode: Int?, success: Bool?, message: String?, validationErrors: [String:[String]]?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        content = try container.decodeIfPresent([MerchantOrderResponse].self, forKey: "Content")
