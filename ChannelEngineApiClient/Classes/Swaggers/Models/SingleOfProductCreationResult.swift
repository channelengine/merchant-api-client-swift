...
open class SingleOfProductCreationResult: Codable {
    ...
    public init(content: ProductCreationResult?, statusCode: Int?, success: Bool?, message: String?, validationErrors: [String:[String]]?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        content = try container.decodeIfPresent(ProductCreationResult.self, forKey: "Content")
