//
// CollectionOfChannelReturnResponse.swift
//
...
open class CollectionOfChannelReturnResponse: Codable {

    public var content: [ChannelReturnResponse]?
    ...
    public init(content: [ChannelReturnResponse]?, count: Int?, totalCount: Int?, itemsPerPage: Int?, statusCode: Int?, success: Bool?, message: String?, validationErrors: [String:[String]]?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        content = try container.decodeIfPresent([ChannelReturnResponse].self, forKey: "Content")
