...
public struct SingleOfMerchantProductResponse: Codable, Hashable {
    ...
    public init(content: MerchantProductResponse? = nil, statusCode: Int? = nil, logId: Int? = nil, success: Bool? = nil, message: String? = nil, validationErrors: [String: [String]]? = nil) {
