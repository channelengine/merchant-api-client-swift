...
public struct SingleOfMerchantProductResponse: Codable, Hashable {
    ...
    public init(content: MerchantProductResponse? = nil, statusCode: Int? = nil, requestId: String? = nil, logId: String? = nil, success: Bool? = nil, message: String? = nil, validationErrors: [String: [String]]? = nil) {
