...
public struct CollectionOfMerchantProductBundleResponse: Codable {
    ...
    public init(content: [MerchantProductBundleResponse]?, count: Int?, totalCount: Int?, itemsPerPage: Int?, statusCode: Int?, logId: Int?, success: Bool?, message: String?, validationErrors: [String:[String]]?) {
