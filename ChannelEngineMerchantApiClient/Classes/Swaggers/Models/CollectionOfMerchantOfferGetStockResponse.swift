...
public struct CollectionOfMerchantOfferGetStockResponse: Codable {
    ...
    public init(content: [MerchantOfferGetStockResponse]?, count: Int?, totalCount: Int?, itemsPerPage: Int?, statusCode: Int?, logId: Int?, success: Bool?, message: String?, validationErrors: [String:[String]]?) {
